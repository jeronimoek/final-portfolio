          ...
          <div className="flex flex-col gap-20">
            ...
            <div className="secondary-text font-normal">
              ...
              <p className="mt-6">
                ...
                He trabajado con una amplia variedad de tecnologías en el lado
                del cliente y del servidor, lo que me ha permitido adquirir una
                comprensión integral de cómo construir aplicaciones web
                eficientes y escalables. Algunas de las tecnologías con las que
                tengo experiencia incluyen React, Node.js, Express, GraphQL,
                bases de datos SQL y NoSQL, servicios cloud, ORMs como Prisma,
                gestores como Directus.{" "}
